...
//
//import sokoban.SokobanBehavior;
...
//	 * @param sokBeh: a SokobanBehavior associated with the relevant domain and planners.
...
//	 */
//	public AffordanceLearnerSokoban(SokobanBehavior sokBeh, KnowledgeBase kb, Map<Integer,LogicalExpression> lgds, int numWorlds, boolean useOptions, boolean useMAs, double fractOfStatesToUse, List<AbstractGroundedAction> allActions) {
//		this.lgds = lgds;
//		this.sokBeh = sokBeh;
...
//		mapMaker.generateNMaps(this.numWorldsPerLGD, new PlaneWorld(numLavaBlocks), 2, 2, 3);
//	}
//	
//	/**
...
//		this.sokBeh.updateMap(map);
//		
//		// Create planners
//		MinecraftPlanner mcPlanner = new VIPlanner(sokBeh, this.useOptions, this.useMAs);
//		OOMDPPlanner planner = mcPlanner.retrievePlanner();
//		
//		// Synthesize a policy on the given map
//		Policy p = sokBeh.solve(planner);
//		
...
//		State initialState = sokBeh.getInitialState();
...
//			if (sokBeh.getTerminalFunction().isTerminal(st)) {
//				continue;
//			}
//			
...
//		List<AbstractGroundedAction> allActions = getAllActions(this.sokBeh, false, false);
//		
...
//	 * @param sokBeh: The SokobanBehavior object to plan with.
...
//	 * @return
//	 */
//	public static String generateSokobanKB(SokobanBehavior sokBeh, int numWorlds, boolean learningRate, boolean useOptions, boolean useMAs, double fracOfStateSpace, String jobID) {
//		
//		// Get Actions
//		List<AbstractGroundedAction> allGroundedActions = getAllActions(sokBeh, useOptions, useMAs);
//		
//		// Create lgd list, predicate list, and knowledge base template.
//		Map<Integer, LogicalExpression> lgds = getSokobanGoals(sokBeh);
//		KnowledgeBase affKnowledgeBase = generateBlankAffordanceKB(getSokobanPredicates(sokBeh), lgds, allGroundedActions);
//		
//		// Initialize Learner
//		AffordanceLearnerSokoban affLearn = new AffordanceLearnerSokoban(sokBeh, affKnowledgeBase, lgds, numWorlds, useOptions, useMAs, fracOfStateSpace, allGroundedActions);
//
//		String kbName;
//		String kbDir = "";
//		if(learningRate) {
...
//	 */
//	private static Map<Integer,LogicalExpression> getSokobanGoals(SokobanBehavior sokBeh) {
//		// Set up goal description list
//		Map<Integer,LogicalExpression> lgds = new HashMap<Integer,LogicalExpression>();
//		
//		PropositionalFunction atGoal = sokBeh.pfAgentAtGoal;
//		LogicalExpression atGoalLE = AffordanceUtils.pfAtomFromPropFunc(atGoal);
//		
//		PropositionalFunction hasGoldOre = sokBeh.pfAgentHasAtLeastXGoldOre;
//		LogicalExpression goldOreLE = AffordanceUtils.pfAtomFromPropFunc(hasGoldOre);
//		
//		PropositionalFunction hasGoldBlock = sokBeh.pfAgentHasAtLeastXGoldBar;
...
//	}
//	
//	private static List<LogicalExpression> getSokobanPredicates(SokobanBehavior sokBeh) {
//		// Set up precondition list
//		List<LogicalExpression> predicates = new ArrayList<LogicalExpression>();
//		
//		// AgentInAir PFAtom
//		PropositionalFunction agentInAir = sokBeh.pfAgentInMidAir;
//		LogicalExpression agentInAirLE = AffordanceUtils.pfAtomFromPropFunc(agentInAir);
//		
//		// EndOfMapInFrontOfAgent PFAtom
//		PropositionalFunction endOfMapInFrontOfAgent = sokBeh.pfEndOfMapInFrontOfAgent;
...
//		generateSokobanKB(mcBeh, numWorldsToLearnWith, false, addOptions, addMAs, fractionOfStateSpaceToLearnWith, jobID);
//	}
//	
//}
...
public class DungeonStateGenerator {
	...
	public static State getCurrentState(Domain domain) {
		...
		agent.setValue(NameSpace.ATX, curPos.x - BurlapWorldGenHandler.finderDungeonPos.x);
		agent.setValue(NameSpace.ATY, curPos.y - BurlapWorldGenHandler.finderDungeonPos.y);
		agent.setValue(NameSpace.ATZ, curPos.z - BurlapWorldGenHandler.finderDungeonPos.z);

...
public class WorldGenBridgeDungeon extends WorldGenerator implements IWorldGenerator
{
	public WorldGenBridgeDungeon() { }
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		world.setBlockMetadataWithNotify(x+1, y+0, z+2, 2, 2);
		world.setBlock(x+2, y+1, z+2, Block.getBlockById(11));
		world.setBlock(x+3, y+1, z+2, Block.getBlockById(11));
		world.setBlockMetadataWithNotify(x+3, y+0, z+2, 2, 2);
		...
		world.setBlock(x+1, y+2, z+1, Block.getBlockById(7));
		world.setBlock(x+2, y+2, z+1, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+2, z+3, Block.getBlockById(7));
		world.setBlock(x+2, y+2, z+3, Block.getBlockById(7));
		...
		world.setBlock(x+4, y+3, z+2, Block.getBlockById(7));
		...
		world.setBlock(x+3, y+3, z+3, BurlapMod.burlapStone);
		world.setBlock(x+4, y+3, z+3, Block.getBlockById(7));
		...
		world.setBlock(x+4, y+3, z+4, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+0, Block.getBlockById(7));
		world.setBlock(x+1, y+4, z+0, Block.getBlockById(7));
		world.setBlock(x+2, y+4, z+0, Block.getBlockById(7));
		world.setBlock(x+3, y+4, z+0, Block.getBlockById(7));
		world.setBlock(x+4, y+4, z+0, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+1, Block.getBlockById(7));
		...
		world.setBlock(x+4, y+4, z+1, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+2, Block.getBlockById(7));
		...
		world.setBlock(x+4, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+3, Block.getBlockById(7));
		...
		world.setBlock(x+4, y+4, z+3, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+4, Block.getBlockById(7));
		world.setBlock(x+1, y+4, z+4, Block.getBlockById(7));
		world.setBlock(x+2, y+4, z+4, Block.getBlockById(7));
		world.setBlock(x+3, y+4, z+4, Block.getBlockById(7));
		world.setBlock(x+4, y+4, z+4, Block.getBlockById(7));
		world.setBlock(x+0, y+5, z+0, Block.getBlockById(7));
		world.setBlock(x+1, y+5, z+0, Block.getBlockById(7));
		world.setBlock(x+2, y+5, z+0, Block.getBlockById(7));
		world.setBlock(x+3, y+5, z+0, Block.getBlockById(7));
		world.setBlock(x+4, y+5, z+0, Block.getBlockById(7));
		world.setBlock(x+0, y+5, z+1, Block.getBlockById(7));
		world.setBlock(x+1, y+5, z+1, Block.getBlockById(7));
		world.setBlock(x+2, y+5, z+1, Block.getBlockById(7));
		world.setBlock(x+3, y+5, z+1, Block.getBlockById(7));
		world.setBlock(x+4, y+5, z+1, Block.getBlockById(7));
		world.setBlock(x+0, y+5, z+2, Block.getBlockById(7));
		world.setBlock(x+1, y+5, z+2, Block.getBlockById(7));
		world.setBlock(x+2, y+5, z+2, Block.getBlockById(7));
		world.setBlock(x+3, y+5, z+2, Block.getBlockById(7));
		world.setBlock(x+4, y+5, z+2, Block.getBlockById(7));
		world.setBlock(x+0, y+5, z+3, Block.getBlockById(7));
		world.setBlock(x+1, y+5, z+3, Block.getBlockById(7));
		world.setBlock(x+2, y+5, z+3, Block.getBlockById(7));
		world.setBlock(x+3, y+5, z+3, Block.getBlockById(7));
		world.setBlock(x+4, y+5, z+3, Block.getBlockById(7));
		world.setBlock(x+0, y+5, z+4, Block.getBlockById(7));
		world.setBlock(x+1, y+5, z+4, Block.getBlockById(7));
		world.setBlock(x+2, y+5, z+4, Block.getBlockById(7));
		world.setBlock(x+3, y+5, z+4, Block.getBlockById(7));
		world.setBlock(x+4, y+5, z+4, Block.getBlockById(7));

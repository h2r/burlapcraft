...
public class WorldGenBridgeDungeon extends WorldGenerator implements IWorldGenerator
{
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		world.setBlock(x+3, y+2, z+3, BurlapMod.burlapStone);
		...
		world.setBlock(x+1, y+4, z+1, Block.getBlockById(7));
		world.setBlock(x+2, y+4, z+1, Block.getBlockById(7));
		world.setBlock(x+3, y+4, z+1, Block.getBlockById(7));
		world.setBlock(x+4, y+4, z+1, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+1, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+2, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+3, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+4, y+4, z+2, Block.getBlockById(7));
		world.setBlock(x+0, y+4, z+3, Block.getBlockById(7));
		world.setBlock(x+1, y+4, z+3, Block.getBlockById(7));
		world.setBlock(x+2, y+4, z+3, Block.getBlockById(7));
		world.setBlock(x+3, y+4, z+3, Block.getBlockById(7));

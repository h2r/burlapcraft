package com.kcaluru.burlapcraft.helper;
...
import com.kcaluru.burlapcraft.item.ItemFilter;
...
public class HelperActions {
  ...
  protected static HelperPos pos1 = null;
  protected static HelperPos pos2 = null;
...
//  public abstract void desync();
  ...
  public static HelperPos getPos2()
  {
    return pos2;
  }
//
...
//  }
  ...
  public static HelperPos findBlock(Block blockType)
  {
  ...
  public static boolean isFacingBlock(int x, int y, int z, ForgeDirection blockSide, HelperBlockSide half)
  {
    if (!isFacingBlock(x, y, z, sideToDir(blockSide))) {
      return false;
    }
    double fy = getObjectMouseOver().hitVec.yCoord - y;
    return ((half != HelperBlockSide.LOWER_HALF) && (fy > 0.5D)) || ((half != HelperBlockSide.UPPER_HALF) && (fy <= 0.5D));
  }
  ...
  public static void overrideSneak()
  {
    ...
    mc.gameSettings.keyBindSneak = new HelperClickInteractions(mc.gameSettings.keyBindSneak.getKeyDescription(), 503, mc.gameSettings.keyBindSneak.getKeyCategory(), sneakKeyJustPressed);
  }
  ...
  public static Entity getClosestEntity(int dist, IEntitySelector selector)
  {
    ...
    for (Entity e : entities) {
      double mydist = e.getDistanceSqToEntity((Entity)HelperActions.mc.thePlayer);
      if (mydist < mindist) {
        found = e;
        mindist = mydist;
      }

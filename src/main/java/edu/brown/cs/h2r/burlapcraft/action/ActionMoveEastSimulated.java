...
public class ActionMoveEastSimulated extends ActionMoveForwardSimulated {
	private int[][][] map;
	private int rotDir = 3;

	public ActionMoveEastSimulated(String name, Domain domain, int[][][] map) {

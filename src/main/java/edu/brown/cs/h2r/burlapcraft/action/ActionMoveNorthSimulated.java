...
public class ActionMoveNorthSimulated extends ActionMoveForwardSimulated {
	private int[][][] map;
	private int rotDir = 2;

	public ActionMoveNorthSimulated(String name, Domain domain, int[][][] map) {
